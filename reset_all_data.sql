-- מחיקת כל הנתונים של Demo Organization (org_id = 3)
...
-- הוספת נהגים אמיתיים (צריך קודם להוסיף users)
-- הוספת משתמשים עבור הנהגים
...
-- הוספת נהגים (צריך להשתמש ב-user_id שנוצר)
...
-- הוספת נסיעות להיום (29.01.2026) - בוקר
INSERT INTO jobs (org_id, customer_id, from_site_id, to_site_id, material_id, scheduled_date, planned_qty, actual_qty, unit, driver_id, truck_id, status, priority, created_at, created_by)
SELECT 
    3,
    c.id,
    s1.id,
...
AND t.org_id = 3 AND t.plate_number = '1234567'
LIMIT 1;
...
-- הוספת נסיעות להיום (29.01.2026) - צהריים
INSERT INTO jobs (org_id, customer_id, from_site_id, to_site_id, material_id, scheduled_date, planned_qty, actual_qty, unit, driver_id, truck_id, status, priority, created_at, created_by)
SELECT 
    3,
    c.id,
...
AND t.org_id = 3 AND t.plate_number = '8901234'
LIMIT 1;

-- הוספת נסיעות למחר (30.01.2026) - בוקר
INSERT INTO jobs (org_id, customer_id, from_site_id, to_site_id, material_id, scheduled_date, planned_qty, actual_qty, unit, driver_id, truck_id, status, priority, created_at, created_by)
SELECT 
    3,
    c.id,
