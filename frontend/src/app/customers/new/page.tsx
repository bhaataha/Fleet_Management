...
export default function NewCustomerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMsg = err.response?.data?.detail || err.message || 'שגיאה ביצירת לקוח'
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <h1 className="text-3xl font-bold text-gray-900">לקוח חדש</h1>
            <p className="text-gray-600 mt-1">הוספת לקוח למערכת</p>
          </div>
        </div>
